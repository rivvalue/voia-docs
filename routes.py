...
@app.route('/api/campaigns/<int:campaign_id>/executive-reports', methods=['GET'])
@require_business_auth
@require_permission('view_campaigns')
...
@app.route('/api/campaigns/<int:campaign_id>/executive-reports/download', methods=['GET'])
@require_business_auth
@require_permission('view_campaigns')
...
@app.route('/api/campaigns/<int:campaign_id>/executive-reports/generate', methods=['POST'])
@require_business_auth
@require_permission('admin')
def generate_executive_report_manually(campaign_id):
    ...
    try:
        ...
        # Queue executive report generation
        ...
        logger.info(f"Manual executive report generation queued for campaign {campaign.id} by {g.authenticated_email}")
